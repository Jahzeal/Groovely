...
export const CreatorCard = ({ id, name, role, image, isFollowing = false, onFollow }: CreatorCardProps) => {
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <button 
        ...
        className={`w-[100px] py-1.5 rounded-lg text-xs font-bold transition-all duration-300 ${
          isFollowing 
