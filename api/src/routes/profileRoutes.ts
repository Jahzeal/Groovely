...
router.patch('/creator/profile', authMiddleware, requireCreator, updateCreatorProfileController);
...
router.patch('/fan/profile', authMiddleware, requireFan, updateFanProfileController);
